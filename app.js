...
if (!localStorage.getItem('productos')) {
    localStorage.setItem('productos', JSON.stringify([
        ...
        { id: 3,  nombre: 'The Matrix',                      categoria: 'Ciencia ficción', cantidad: 6,  precio: 12.99, descripcion: 'Un programador descubre que la realidad que conoce es una simulación controlada por máquinas.',            anio: 1999, poster: './posters/the-matrix.jpg' },
